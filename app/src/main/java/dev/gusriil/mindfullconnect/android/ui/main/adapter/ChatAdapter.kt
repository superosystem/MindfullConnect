...
import dev.gusriil.mindfullconnect.android.databinding.ItemLeftMessageBinding
import dev.gusriil.mindfullconnect.android.databinding.ItemRightMessageBinding
import dev.gusriil.mindfullconnect.android.dto.message.MessageModel
import dev.gusriil.mindfullconnect.android.utils.ViewUtils.adjustTimePattern
...
class ChatAdapter(private val myProfileId: Long) :
    ...
    inner class LeftMsgHolder(private val binding: ItemLeftMessageBinding) :
        ...
        fun bind(message: MessageModel) = with(binding) {
            ...
            Glide.with(ivAvatar).load(message.user.avatarModel?.avatarUrl)
