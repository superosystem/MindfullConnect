package dev.gusriil.mindfullconnect.android.ui.auth
...
import dev.gusriil.mindfullconnect.android.databinding.ActivityAuthBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        authViewModel.authEvent.observe(this) {
            if (it == AuthEventType.LOGGED_IN) {
                Toast.makeText(this, getString(R.string.log_in_successfully), Toast.LENGTH_LONG)
                    .show()
            } else Toast.makeText(this, getString(R.string.sign_up_successfully), Toast.LENGTH_LONG)
                .show()
