package com.gusrylmubarok.cargotracker.bookingms.domain.projections;

import com.gusrylmubarok.cargotracker.bookingms.domain.model.RoutingStatus;

import javax.persistence.*;
import java.util.Date;

/*
** Projection class for the Cargo Aggregate implemented as a regular JPA Entity.
** Contains a summary of the Cargo Aggregate
*/
@Entity
